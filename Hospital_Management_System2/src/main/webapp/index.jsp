...
<div class="ui container first">
    <div class="ui center aligned teal inverted segment">
        <font color="white"><h1 class="header" id="nam">Hospital Management System</h1></font>
    </div>
  <div class="clear"> </div>
			<!--start-image-slider---->
  ...
  <br><br><footer>
   <div class="ui icon">
               <center>
                ...
                <button class="ui blue button">Contact Us</button></a>
                </center>
    <p class="copyright">© HMS | All rights reserved.</p>
</footer>
</div>   
