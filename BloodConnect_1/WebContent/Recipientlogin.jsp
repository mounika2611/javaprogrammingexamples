...
<input name="RecipientuserId" class="form-login" title="RecipientName" value="" size="30" maxlength="50" />

</div><br></br>
<div id="login-box-name">Recipient Password:</div><br>
<div id="login-box-field">
<input name="Recipientpassword" type="Recipientpassword" class="form-login" title="Recipientpassword" value="" size="30" maxlength="48" />
</div>
<br />
