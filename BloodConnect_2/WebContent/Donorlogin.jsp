...
<input name="DonoruserId"  title="DonorName" value="" size="30" maxlength="50" />

</div><br></br>
<div id="login-box-name">DonorPassword:</div><br>
<div id="login-box-field">
<input name="Donorpassword" type="Donorpassword" title="Donorpassword" value="" size="30" maxlength="48" />
</div>
<br />
