...
public class RecipientLoginServlet extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	 ...
	 boolean result = recipientloginService.authenticateUser(RecipientUserId, RecipientPassword);
	 Recipient recipient = recipientloginService.getUserByUserId(RecipientUserId);
	 if(result == true){
