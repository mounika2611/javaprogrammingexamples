...
public class DonorRegisterServlet extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	 ...
	 try {	
		DonorRegisterService donorregisterService = new DonorRegisterService();
		 boolean result = donorregisterService.register(donor);		
		 out.println("<html>");
		 out.println("<head>");		
	    ...
	    out.println("<body  style=\"background-image:url('Images/blue_background.jpg')\">");
		 ...
		 if(result){
			 ...
			 out.println("To login with new UserId and Password<a href=Donorlogin.jsp>Click here</a>");
		 }else{
