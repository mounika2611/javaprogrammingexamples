...
<input name="DonorUserId" class="form-login" title="DonorUserId" value="" size="30" maxlength="50" />

</div><br></br>
<div id="login-box-name">DonorPassword:</div><br>
<div id="login-box-field">
<input name="DonorPassword" type="password" class="form-login" title="DonorPassword" value="" size="30" maxlength="48" />
</div>
<br />
